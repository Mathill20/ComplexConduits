...
public abstract class ContainerCConduits extends Container {

    private int inventorySize;

    public ContainerCConduits(int inventorySize) {

        this.inventorySize = inventorySize;
    }

    @Override
    public ItemStack transferStackInSlot(EntityPlayer pl,
                                         int i) {
