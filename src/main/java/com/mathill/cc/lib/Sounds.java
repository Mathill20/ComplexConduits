...
public class Sounds {
    ...
    private static final String SOUND_RESOURCE_LOCATION = "mods/cconduit/sound/";
    private static final String SOUND_PREFIX            = "mods.cconduit.sound.";

    public static String[]      soundFiles              = { SOUND_RESOURCE_LOCATION + "chargeDown.ogg", SOUND_RESOURCE_LOCATION + "chargeUp.ogg",
